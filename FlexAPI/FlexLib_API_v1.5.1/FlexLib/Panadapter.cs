...
namespace Flex.Smoothlake.FlexLib
{
    public class Panadapter : ObservableObject
    {
        ...
        /// <param name="size">The Size of the panadapter</param>
        public Panadapter(Radio radio, Size size)
        {
        ...
        /// <summary>
        /// Enables or disables the Noise Blanker (NB) for the Panadapter.
        /// </summary>
        public bool NBOn
        {
            get { return _nb_on; }
            set
            {
                ...
                {
                    _nb_on = value;
                    _radio.SendCommand("display pan set 0x" + _stream_id.ToString("X") + " nb=" + Convert.ToByte(value));
        ...
        public int NBLevel
        {
            ...
            set
            {
                ...
                {
                    _nb_level = new_val;
                    _radio.SendCommand("display pan set 0x" + _stream_id.ToString("X") + " nb_level=" + _nb_level);
        ...
        private bool _nb_updating = false;
        /// <summary>
        /// Gets whether the Noise Blanker is currently updating
        /// </summary>
        public bool NBUpdating
        {
            get { return _nb_updating; }
        }
        ...
        public Size Size
        {
            ...
            set
            {
                ...
                if (_size != value)
                {
                    ...
                    _radio.SendCommand("display pan set 0x" + _stream_id.ToString("X") + " xpixels=" + (int)_size.Width + " ypixels=" + (int)_size.Height);
        ...
        internal void AddData(ushort[] data, uint start_bin, uint frame, int packet_count)
        {
            ...
            // check boundaries
            if (start_bin + data.Length > (int)_size.Width)
            {
                return;
            }
            ...
            if (frame == _current_frame)
            {
                ...
                if (_frame_bins == (int)_size.Width)
                {
                    try
                    {
                    ...
                    case "nb_updating":
                        {
                            ...
                            if (_nb_updating == Convert.ToBoolean(temp))
                                continue;

                            _nb_updating = Convert.ToBoolean(temp);
                            RaisePropertyChanged("NBUpdating");
                        }
                        break;
