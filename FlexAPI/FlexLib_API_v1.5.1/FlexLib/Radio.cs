...
namespace Flex.Smoothlake.FlexLib
{
    ...
    public class Radio : ObservableObject
    {
                        ...
                        switch (words[1])
                        {
                            case "pan":
                                ...
                                if (pan == null)
                                {
                                    ...
                                    pan = new Panadapter(this, new Size(0, 0));
                            ...
                            case "waterfall":
                                ...
                                {
                                    if (s.Contains("removed")) return;
                                    fall = new Waterfall(this, new Size(0, 0));
        ...
        /// </summary>
        /// <param name="size">The display size of the Panadapter</param>
        /// <returns>The Panadapter object</returns>
        public Panadapter CreatePanadapter(Size size)
        {
            return new Panadapter(this, size);
        }
        ...
        public Waterfall CreateWaterfall(Size size)
        {
            return new Waterfall(this, size);
        }
        ...
        public int TXCWMonitorPan
        {
            ...
            set
            {
                ...
                if (_txCWMonitorPan != new_gain)
                {
                    _txCWMonitorPan = new_gain;
        ...
        private void UpdateWaveformsInstalledList(string s)
        {
            ...
            foreach (string wave in inputs)
            {
                if (wave != "")
                {
                    _waveformsInstalledList.Add(wave);
                }
            }
        ...
        private void UpdateProfileListSelection(string profile_type, string profile_name)
        {
            ...
            {
                case "global":
                    if (_profileGlobalList.Contains(profile_name))
                    {
                ...
                case "tx":
                    ...
                    break;
                case "mic":
                    if (_profileMicList.Contains(profile_name))
                    {
                    ...
                    break;
                case "displays":
                    if (_profileDisplayList.Contains(profile_name))
                    {
