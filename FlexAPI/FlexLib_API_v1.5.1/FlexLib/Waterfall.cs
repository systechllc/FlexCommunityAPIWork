...
namespace Flex.Smoothlake.FlexLib
{
    public class Waterfall : ObservableObject
    {
        ...
        public Waterfall(Radio radio, Size size)
        {
        ...
        public bool RequestWaterfallFromRadio()
        {
            ...
            _radio.SendReplyCommand(new ReplyHandler(UpdateStreamID), "display panafall create x=" + (int)_size.Width + " y=" + (int)_size.Height);
